...
public class HttpProxyEndpointConnectorFactory implements EndpointSyncConnectorFactory<HttpProxyEndpointConnector> {
    ...
    public HttpProxyEndpointConnector createConnector(
        ...
        try {
            return new HttpProxyEndpointConnector(
                ...
                eval(
                    deploymentContext,
                    connectorFactoryHelper.readConfiguration(HttpProxyEndpointConnectorEndpointGroupConfiguration.class, groupConfiguration)
                )
            );
        } catch (Exception e) {
    ...
    private HttpProxyEndpointConnectorEndpointGroupConfiguration eval(
        final DeploymentContext deploymentContext,
