...
public class DefaultEndpointManager extends AbstractService<EndpointManager> implements EndpointManager, TemplateVariableProvider {
    ...
    private void createAndStartEndpoint(final ManagedEndpointGroup managedEndpointGroup, final Endpoint endpoint) {
        try {
            ...
            final String groupConfiguration = getEndpointGroupConfiguration(managedEndpointGroup.getDefinition(), endpoint);
            ...
            final EndpointConnector connector = connectorFactory.createConnector(deploymentContext, configuration, groupConfiguration);
    ...
    private String getEndpointGroupConfiguration(EndpointGroup endpointGroup, Endpoint endpoint) {
        return endpoint.isInheritConfiguration() ? endpointGroup.getSharedConfiguration() : endpoint.getGroupConfiguration();
    }
}
