...
public class ApiSearchServiceImpl extends AbstractService implements ApiSearchService {
    ...
    @Override
    public Collection<GenericApiEntity> search(ExecutionContext executionContext, final ApiQuery query) {
    ...
    public Collection<String> searchIds(
        ...
        Query<GenericApiEntity> searchEngineQuery = QueryBuilder
            .create(GenericApiEntity.class)
            .setQuery(query)
            .setSort(sortable)
            .setFilters(filters)
            .build();
        SearchResult searchResult = searchEngineService.search(executionContext, searchEngineQuery);
