...
public class EndpointsResource {
    ...
    @GET
    @Path("/{endpointId}/endpointGroupSchema")
    @Produces(MediaType.APPLICATION_JSON)
    public String getEndpointGroupSchema(@PathParam("endpointId") String endpointId) {
        // Check that the entrypoint exists
        endpointService.findById(endpointId);

        return endpointService.getEndpointGroupSchema(endpointId);
    }
}
